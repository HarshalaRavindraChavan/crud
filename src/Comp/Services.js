                        ...
                        <div className="row">
                          <div className="col-lg-6 align-self-center">
                            <div className="left-text">
                              ...
                              <div className="ticks-list"><span><i className="fa fa-check" /> Optimized Template</span> <span><i className="fa fa-check" /> Data Info</span> <span><i className="fa fa-check" /> SEO Analysis</span>
                                <span><i className="fa fa-check" /> Data Info</span> <span><i className="fa fa-check" /> SEO Analysis</span> <span><i className="fa fa-check" /> Optimized Template</span></div>
                  ...
                  <li>
                    <div>
                      <div className="thumb">
                        <div className="row">
                          <div className="col-lg-6 align-self-center">
                            <div className="left-text"popover id="myheader">

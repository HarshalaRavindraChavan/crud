        ...
        <form id="contact" action method="post">
          <div className="row">
            ...
            <div className="col-lg-5">
              <div id="map">
                <iframe src="https://maps.google.com/maps?q=Av.+L%C3%BAcio+Costa,+Rio+de+Janeiro+-+RJ,+Brazil&t=&z=13&ie=UTF8&iwloc=&output=embed" width="100%" height="636px" frameBorder={0} style={{border: 0}} allowFullScreen />
              </div>
            </div>
